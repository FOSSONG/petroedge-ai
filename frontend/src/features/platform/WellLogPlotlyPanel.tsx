...
export function WellLogPlotlyPanel() {
  ...
  const plot = useMemo(() => {
    ...
    const layout = {
      ...
      xaxis: axis("GR", "API", domains[0], { range: [0, 150], tickvals: [0, 75, 150] }),
      xaxis2: axis("RT", "Ω·m", domains[1], { type: "log", range: [-0.7, 3.3], tickvals: [0.2, 20, 2000] }),
      xaxis3: axis("RHOB", "g/cm³", domains[2], { range: [1.95, 2.95], tickvals: [1.95, 2.45, 2.95] }),
      xaxis4: axis("NPHI", "v/v", domains[3], { range: [0.45, -0.15], tickvals: [0.45, 0.15, -0.15] }),
      xaxis5: axis("PHI", "v/v", domains[4], { range: [0, 0.4], tickvals: [0, 0.2, 0.4] }),
      xaxis6: axis("SW", "v/v", domains[5], { range: [0, 1], tickvals: [0, 0.5, 1] }),
      xaxis7: axis("HC PROB", "fraction", domains[6], { range: [0, 1], tickvals: [0, 0.5, 1] }),
    };
          ...
          <Stack minWidth={{ md: 320 }} gap={1}>
            ...
            <Stack direction="row" gap={1}>
              <Button
                ...
                onClick={refresh}
                disabled={!datasetId || datasets.isFetching || interpretation.isFetching}
